...
export default function BatchSlice(props) {
    ...
    return (
        <div className={visible ? "grid place-items-center m-3 border-4 border-gray-100 rounded-lg p-3 w-fit" : "hidden"}>
            <div className="form-control max-w-xs w-fit m-1">
                <span className="label-text text-white font-['Oswald']">Product Name</span>                
                <input type="text" onChange={e => setProdName(e.target.value)} defaultValue={props.prodName} className="input input-bordered w-fit max-w-xs bg-gray-100 font-['Merriweather'] text-slate-800" />
            </div>
            <div className="form-control max-w-xs w-fit m-1">
                <span className="label-text text-white font-['Oswald']">Company</span>
                <input type="text" onChange={e => setCompName(e.target.value)} defaultValue={props.compName} className="input input-bordered w-fit max-w-xs bg-gray-100 font-['Merriweather'] text-slate-800" />
            </div>
            ...
            <Calendar className={hasDate ? "w-fit font-['Oswald'] rounded-lg" : "hidden"} onChange={setExpDate} value={new Date()}/>
